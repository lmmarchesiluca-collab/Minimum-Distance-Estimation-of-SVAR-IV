...
% --- RESTRIZIONE DI LAKDAWALA ---
% Imponiamo che lo shock di Forward Guidance (colonna 2) 
% non abbia effetto contemporaneo sul Fed Funds Rate (riga 1).
B1(1, 2) = 0; 
...
Phi = [exp(a11) 0;
       a21      exp(a22)];            % r x g (Lo zero qui è per Angelini-Fanelli)
